...
function transform(image, trans)
    ...
    t_11 = M * [ 1; 1 ] + translation;
    t_1w = M * [ 1; w ] + translation;
    t_h1 = M * [ h; 1 ] + translation;
    t_hw = M * [ h; w ] + translation;
    
    t_ymin = min([ t_11(1), t_1w(1), t_h1(1), t_hw(1) ]);
    t_xmin = min([ t_11(2), t_1w(2), t_h1(2), t_hw(2) ]);
    
    t_h = max([ t_11(1), t_1w(1), t_h1(1), t_hw(1) ]) - t_ymin;
    t_w = max([ t_11(2), t_1w(2), t_h1(2), t_hw(2) ]) - t_xmin;

    t_image = zeros(ceil(t_h), ceil(t_w));
